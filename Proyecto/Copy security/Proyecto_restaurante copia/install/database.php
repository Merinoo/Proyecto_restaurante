...
$connection->query("INSERT INTO `usuarios` (`idusuario`, `Username`, `Password`, `Email`, `Actividad`, `Tipo`, `Dni_usuario`, `Nombre`, `Apellidos`, `Cpostal`, `Telefono`, `Sexo`, `FNacimiento`, `Direccion`,`Tema`) VALUES
...
(9, 'juandiadmin', '81dc9bdb52d04dc20036dbd8313ed055', 'pekechis@gmail.com', 'Activo', 'admin', '7867687D', 'Juan Diego', 'Perez', 41914, 987654321, 'Hombre', '0000-00-00', 'C/Triana',1),
